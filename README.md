...
The sobering facts: 100% security does not exist. All we can do is slow things down and avoid the obvious. Also, security is not code poetry. It isn't pretty. More often than not, it involves sticking to the basics and being strict in how the code is supposed to flow. 
